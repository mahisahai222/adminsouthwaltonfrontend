...
``` bash
# dev server with hot reload at http://44.196.64.110:2023
$ npm start 
```
...
Navigate to [http://44.196.64.110:2023](http://44.196.64.110:2023). The app will automatically reload if you change any of the source files.
