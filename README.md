...
``` bash
# dev server with hot reload at http://3.223.253.106:2023
$ npm start 
```
...
Navigate to [http://3.223.253.106:2023](http://3.223.253.106:2023). The app will automatically reload if you change any of the source files.
