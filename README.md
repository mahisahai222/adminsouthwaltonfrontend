...
``` bash
# dev server with hot reload at http://54.236.98.193:2023
$ npm start 
```
...
Navigate to [http://54.236.98.193:2023](http://54.236.98.193:2023). The app will automatically reload if you change any of the source files.
