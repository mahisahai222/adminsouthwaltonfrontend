...
const DriverManageList = () => {
  ...
  const fetchDriverBookings = async (driverId) => {
    try {
      const response = await axios.get(`http://3.223.253.106:8132/api/driver/${driverId}/bookings`);
  ...
  const fetchDriverManageData = async () => {
    ...
    try {
      const response = await axios.get(
        `http://3.223.253.106:8132/api/driver?page=${currentPage}&limit=${limit}&search=${searchName}`
      );
  ...
  const handleAddDriverManage = async () => {
    ...
    try {
      const response = await axios.post(
        'http://3.223.253.106:8132/api/driver/add',
        formData,
        {
          headers: {
  ...
  const handleUpdateDriverManage = async () => {
    ...
    try {
      const response = await axios.put(
        `http://3.223.253.106:8132/api/driver/${currentDriverId}`,
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data',
  ...
  const handleDeleteDriverManage = async (id) => {
    try {
      await axios.delete(`http://3.223.253.106:8132/api/driver/${id}`);
