...
const DriverManageList = () => {
  ...
  const fetchDriverBookings = async (driverId) => {
    try {
      const response = await axios.get(`http://54.236.98.193:8132/api/driver/${driverId}/bookings`);
  ...
  const fetchDriverManageData = async () => {
    ...
    try {
      const response = await axios.get(
        `http://54.236.98.193:8132/api/driver?page=${currentPage}&limit=${limit}&search=${searchName}`
      );
  ...
  const handleAddDriverManage = async () => {
    ...
    try {
      const response = await axios.post(
        'http://54.236.98.193:8132/api/driver/add',
        formData,
        {
          headers: {
  ...
  const handleUpdateDriverManage = async () => {
    ...
    try {
      const response = await axios.put(
        `http://54.236.98.193:8132/api/driver/${currentDriverId}`,
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data',
  ...
  const handleDeleteDriverManage = async (id) => {
    try {
      await axios.delete(`http://54.236.98.193:8132/api/driver/${id}`);
